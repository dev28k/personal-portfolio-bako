...
const headerData = {
  name: "Faiz Khan",
  designation: "MERN Stack Developer | Wordpress | Web & App",
  imageThumb: "/images/logo2.png",
  social: {
    // facebook: "https://facebook.com",
    // instagram: "https://www.instagram.com/",
    // pinterest: "https://www.youtube.com/",
    phone: "tel:923195028174",
    whatsapp: "https://wa.me/923338701104?text=Hello%20there!",
  },
};
        ...
        <div className="header-inner d-flex align-items-start flex-column">
          ...
          <div className="footer mt-auto">
            <ul className="social-icons list-inline">
              ...
              {!headerData.social.pinterest ? null : (
                <li className="list-inline-item">
              ...
              {!headerData.social.phone ? null : (
                <li className="list-inline-item">
                  <a href={headerData.social.phone}>
                    <FaPhone />
                  </a>
                </li>
              )}
            ...
            <span className="copyright">
              &copy; {new Date().getFullYear()} Faiz's Resume
            </span>
          </div>
        </div>
      </header>
